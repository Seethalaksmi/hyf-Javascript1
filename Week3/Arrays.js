...
favoriteAnimals.splice(1, 0, "meerkat");//  at index position 1, remove 0 elements, then add "meerkat" to that 
...
favoriteAnimals.splice(3, 1);// Starting at index position 3, remove one element ["giraffe"] and retains ['blowfish', 'meerkat', 'capricorn', 'turtle'].
